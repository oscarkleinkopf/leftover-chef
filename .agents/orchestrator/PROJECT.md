...
| 3 | M3: Interactive Roadmap UI/UX Module | Implement roadmap modal/section, nav entry point, version cards (2.0 to 5.0), voting & interest tracking saved in localStorage. | M1, M2 | IN_PROGRESS |
